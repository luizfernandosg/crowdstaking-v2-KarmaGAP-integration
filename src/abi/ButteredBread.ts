export const butteredBreadAbi = [
  ...
  },
  {
    ...
    outputs: [{ name: "_lpBalance", type: "uint256", internalType: "uint256" }],
    stateMutability: "view",
  },
  {
    type: "function",
  ...
  {
    type: "function",
    name: "modifyScalingFactor",
    inputs: [
      { name: "_lp", type: "address", internalType: "address" },
      { name: "_factor", type: "uint256", internalType: "uint256" },
      { name: "_holders", type: "address[]", internalType: "address[]" },
    ],
    outputs: [],
    stateMutability: "nonpayable",
  },
  ...
  },
  {
    ...
    name: "scalingFactors",
    inputs: [{ name: "lp", type: "address", internalType: "address" }],
    outputs: [{ name: "factor", type: "uint256", internalType: "uint256" }],
    stateMutability: "view",
  },
  {
    type: "function",
